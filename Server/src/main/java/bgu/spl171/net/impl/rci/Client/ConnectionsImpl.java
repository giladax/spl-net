...
public class ConnectionsImpl<T> implements Connections<T> {
    ...
    private AtomicInteger currentConnectionId = new AtomicInteger(69); // It ain't nothing but a thing
    ...
    public int add(ConnectionHandler handler) {
        currentConnectionId.addAndGet(1);
        handlers.put(currentConnectionId.get() , handler);
